# locals {
#   k8s_cert_manager_account_namespace = "cert-manager"
#   k8s_cert_manager_service_account_name = "${var.cluster_name}-cert-manager"
# }
...
#   oidc_fully_qualified_subjects = ["system:serviceaccount:${local.k8s_cert_manager_account_namespace}:${local.k8s_cert_manager_service_account_name}"]
